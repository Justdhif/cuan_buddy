    ...
    <footer className="bg-white text-ink border-t border-hairline/60 pt-20 pb-10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <img
                ...
                className="h-7 w-7"
              />
              <span className="font-semibold text-lg text-primary tracking-tight">CuanBuddy</span>
            </div>
            <p className="text-ink-mute text-[13px] leading-relaxed mb-6 font-light">
          ...
          <div>
            <h3 className="font-semibold text-ink text-sm mb-6">Product</h3>
            <ul className="space-y-4 text-[13px]">
              <li>
                <a
                  href="#features"
                  className="text-ink-mute hover:text-primary transition-colors font-light"
                >
                  Features
                </a>
              </li>
          ...
          <div>
            <h3 className="font-semibold text-ink text-sm mb-6">Company</h3>
            <ul className="space-y-4 text-[13px]">
              <li>
                <a
                  href="#"
          ...
          <div>
            <h3 className="font-semibold text-ink text-sm mb-6">Legal</h3>
            <ul className="space-y-4 text-[13px]">
              <li>
                <a
                  href="#"
